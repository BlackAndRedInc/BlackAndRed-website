...
VALUES
	...
	(9,2,'Monthly Updates','ad','Aspen Dental','When the client lost resources for this Aspen Dental site update, Black & Red was brought on to finish it. Adding to the complexity, the site was geo-enabled from over 500 different locations to allow users to see local phone numbers and schedule appointments. '),
